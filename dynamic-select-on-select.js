...
jQuery(document).ready(function ($) {
  ...
  $(document).on(
    "change",
    '[data-key="field_63bd13eaa6ebc"] .acf-input select',
    function (e) {
  ...
  $('[data-key="field_63bd13eaa6ebc"] .acf-input select').trigger("ready");
});
...
function update_cities_on_state_change(e, $) {
  ...
  var city_select = $('[data-key="field_63c4b7424c412"] select');
  city_select.empty();
